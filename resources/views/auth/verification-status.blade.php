        ...
        <div class="verif-card">
            ...
            @elseif($status === 'approved')
                ...
                <div class="verif-info-box">
                    ...
                    <p>Link undangan grup WhatsApp <strong>{{ $team_name ?? 'Tim' }}</strong> sudah dikirimkan oleh Admin Relawan ke nomor WhatsApp Anda. Silakan cek pesan masuk WhatsApp Anda dan klik link tersebut untuk bergabung.</p>
                    <p style="margin-bottom: 0;">Atau jika belum menerima, Anda bisa bergabung langsung melalui tombol di bawah ini:</p>
                    <a href="{{ $group_link ?? '#' }}" target="_blank" class="btn-wa" style="font-size: 13px; padding: 10px 16px; box-sizing: border-box; margin-top: 10px;">
                        <i data-lucide="message-circle"></i>
