                ...
                <div class="wa-banner" style="background: linear-gradient(135deg, #e0f2f1, #f0fdfa); padding: 20px; border-radius: 12px; margin-bottom: 24px; border: 2px solid #006a60; display: flex; justify-content: space-between; align-items: flex-start; gap: 16px;">
                    <div style="flex: 1;">
                        ...
                        <p style="margin: 0 0 4px 0; font-size: 13px; color: #374151;">
                            Segera hubungi <strong>{{ session('wa_name') }}</strong> untuk mengirim detail evakuasi.
                        </p>
                        ...
                        <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                            ...
                            <a href="{{ session('wa_maps') }}" target="_blank" style="display: inline-flex; align-items: center; gap: 6px; background: white; color: #006a60; padding: 10px 16px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 13px; border: 1px solid #006a60; transition: background 0.2s;">
                    ...
                    <form action="{{ route('relawan.dashboard') }}" method="GET" style="margin: 0; flex-shrink: 0;">
                        <a href="{{ route('relawan.dismiss.wa') }}" style="background: none; border: none; cursor: pointer; color: #9ca3af; padding: 4px; text-decoration: none; display: inline-block;">
